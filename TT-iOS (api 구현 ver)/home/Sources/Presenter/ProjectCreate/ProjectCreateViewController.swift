...
final class ProjectCreateViewController: BaseViewController {
    ...
    override func initView() {
        super.initView()
        [backButton, titleLabel,projectPicture,selectPhotoButton,
...
extension ProjectCreateViewController : UIImagePickerControllerDelegate, UINavigationControllerDelegate {
