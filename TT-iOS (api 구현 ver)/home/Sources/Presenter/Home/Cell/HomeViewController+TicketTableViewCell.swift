//
//  HomeViewController+TicketTableViewCell.swift
//  home
//
...
extension HomeViewController {
    final class TicketTableViewCell: BaseTableViewCell {
        ...
        override func update() {
            ...
            statusLabel.text = ticket.status.textString
...
extension HomeViewController.TicketTableViewCell {
    static func makeCell(to view: UITableView, indexPath: IndexPath, ticket: Ticket) -> HomeViewController.TicketTableViewCell {
        guard let cell = view.dequeueReusableCell(
            withIdentifier: HomeViewController.TicketTableViewCell.reuseIdentifier,
            for: indexPath
        ) as? HomeViewController.TicketTableViewCell else { fatalError("Cell is not registered to view....") }
        cell.ticket = ticket
        return cell
    }
}
